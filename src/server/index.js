...
app.post('/all', (req, res) => {
    ...
    // geonames  base url 
    const gAPI = (`http://api.geonames.org/searchJSON?name=${dest}&maxRows=1&username=marwaalalasi`);
    ...
    fetch(gAPI)
        ...
        .then((gData) => {
            ...
            // Weatherbit base url 
            const wAPI = `https://api.weatherbit.io/v2.0/forecast/daily?&lat=${lat}&lon=${lng}&key=1522b26858e14de2be980d1d38d3b325`;
            ...
            fetch(wAPI)
                ...
                .then(wData => {
                    ...
                    const pAPI = `https://pixabay.com/api/?key=33475284-e34888c892f61a3f123d3756a=${dest}&image_ty`;
